...
#pragma region Helper function declarations
    ...
    AutonomousOutput updateAutonomousFSM_Loitering(Position currentPosition, bool throttleLow);
    AutonomousOutput updateAutonomousFSM_Converging(Position currentPosition,
                                                    float currentHeight, bool throttleLow);
    AutonomousOutput updateAutonomousFSM_Navigating(Position currentPosition, bool throttleLow);
