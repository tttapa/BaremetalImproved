...
TEST(QR, QR) {
    ...
    ASSERT_TRUE(isAlmostEqual(qtr.R, R_expected, eps));
    ASSERT_TRUE(isAlmostEqual(qtr.U, U_expected, eps));
    ASSERT_TRUE(isAlmostEqual(Q, Q_expected, eps));
    ASSERT_TRUE(isAlmostEqual(QTA, QTA_expected, eps));
    ASSERT_TRUE(isAlmostEqual(Q * qtr.R, A, eps));
}