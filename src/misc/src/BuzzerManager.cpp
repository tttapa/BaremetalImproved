...
/** Initiated beep lasts 0.20 seconds. */
static constexpr float INITIATED_DURATION = 0.20;
...
/** Initiated beeps have 0.20 seconds between them. */
static constexpr int INITIATED_DELAY = 0.20;
