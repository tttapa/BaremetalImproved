...
bool readSonar() {
    ...
    newSonarRaw = (real_t) Xil_In32(SONAR::SONAR_ADDR) /
                  (CLOCK_FREQUENCY * SONAR::PWM_TO_HEIGHT);
    ...
    newSonarRaw = getMedian(measurements, SONAR::MAX_MF_LENGTH,
                            SONAR::MF_BUFFER_SIZE_SMALL);
...
real_t getFilteredSonarMeasurement() { return filteredSonarMeasurement; }
